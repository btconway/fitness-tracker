...
- **Program day calculation:** ABC cycle Day 1 = Feb 16, 2026. The ABF4FL program cycles every 28 days (Weeks 1-3 base, Week 4 hypertrophy). Fighter Pullup/Pushup programs start Feb 12, 2026 and count **weekdays only** (Mon-Fri): days 1-12 = 3RM phase, days 13-42 = 5RM phase, then retest. Weekends return a rest day with no prescribed sets.
